...
from resnet101 import ResNetAudio101  # Ensure this points to the ResNet101 implementation if in a different file
...
if __name__ == '__main__':
    ...
    torch.save(train_dataset, "transformed_dataset101.pth")
    ...
    cnn = ResNetAudio101(num_classes=10).to(device)
    ...
    # Save model
    torch.save(cnn.state_dict(), "cnn_model101.pth")
    print("Trained CNN model saved at cnn_model101.pth")
